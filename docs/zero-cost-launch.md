...
9. Create one account, verify the email, complete onboarding, copy the invite link, and open it in a private browser to create another tester.
...
- Resend Free keeps early verification/reset email delivery cheap; local preview links remain available for private local QA.
