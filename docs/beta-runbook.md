...
9. Configure `RESEND_API_KEY` and `MATCHPULSE_FROM_EMAIL` for real verification, reset, and briefing emails.
10. Set `MATCHPULSE_REQUIRE_EMAIL_VERIFICATION=1` and `MATCHPULSE_REQUIRE_EMAIL_DELIVERY=1` before inviting public testers.
